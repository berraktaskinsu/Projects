...
#set_property PACKAGE_PIN L1 [get_ports {led[15]}]  	 	 	 	  			set_property IOSTANDARD LVCMOS33 [get_ports {led[15]}] 
...
#Buttons 
set_property PACKAGE_PIN U18 [get_ports reset_input]  	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports reset_input] 
set_property PACKAGE_PIN T18 [get_ports clk_input]  	 	 	 	 	 
